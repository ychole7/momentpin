...
const S = {
  ...
  loading: { textAlign: 'center', color: '#9b9ba3', padding: 60, fontSize: 14 },
  body: { padding: 16 },
  ...
  statCard: { background: '#fff', borderRadius: 16, padding: '18px 16px', boxShadow: '0 4px 24px rgba(20,20,30,.06)', textAlign: 'center' },
  statNum: { fontSize: 30, fontWeight: 700, letterSpacing: '-1px', color: '#ff4d5e' },
  statLabel: { fontSize: 12.5, color: '#6b6b73', fontWeight: 600, marginTop: 4 },
  secLabel: { fontSize: 12, fontWeight: 600, color: '#9b9ba3', textTransform: 'uppercase', letterSpacing: .4, margin: '4px 4px 10px' },
  rankCard: { background: '#fff', borderRadius: 16, padding: '8px 16px', boxShadow: '0 4px 24px rgba(20,20,30,.06)', marginBottom: 20 },
  rankRow: { display: 'flex', alignItems: 'center', gap: 11, padding: '11px 0', borderBottom: '1px solid #f4f4f6' },
  rankNo: { width: 24, textAlign: 'center', fontSize: 15, fontWeight: 700, color: '#9b9ba3' },
