  ...
  return (
    <div style={S.app}>
      ...
      <div style={S.body}>
        ...
        <p style={S.intro}>모먼핀(이하 "서비스")은 이용자의 개인정보를 중요하게 생각하며, 「개인정보 보호법」 및 「위치정보의 보호 및 이용 등에 관한 법률」 등 관련 법령을 준수합니다.</p>

        <Sec n="1" t="수집하는 개인정보 항목">
          <b>회원가입·계정</b><br/>· 이메일 주소<br/>· 비밀번호(암호화 저장)<br/><br/>
          <b>서비스 이용 과정</b><br/>· 프로필: 표시 이름, 색상<br/>· 위치 정보: 모먼을 남길 때의 좌표 및 행정구역 명칭<br/>· 사진: 모먼으로 업로드한 이미지<br/>· 푸시 알림 토큰(동의 시)<br/>· 그룹 활동: 참여 모먼, 좋아요 등
        </Sec>
        <Sec n="2" t="수집·이용 목적">
          · 회원 식별 및 계정 관리<br/>· 그룹 내 위치·순간 공유 제공<br/>· 모먼 알림 발송<br/>· 서비스 통계 및 개선
        </Sec>
        <Sec n="3" t="위치정보의 처리">
          · 위치는 모먼을 남기는 시점에만 수집되며 상시 수집하지 않습니다.<br/>· 같은 그룹 구성원에게만 공유됩니다.<br/>· 모먼을 남기지 않으면 위치 공유에 참여하지 않을 수 있습니다.<br/>· 제3자에게 제공되지 않습니다.
        </Sec>
        <Sec n="4" t="보관 및 이용 기간">
          · 회원 자격 유지 동안 보관합니다.<br/>· 탈퇴 시 모든 개인정보가 지체 없이 파기됩니다.<br/>· 법령상 보존 의무가 있는 경우 해당 기간 보관할 수 있습니다.
        </Sec>
        <Sec n="5" t="개인정보의 파기">
          · 앱 내 "회원 탈퇴" 시 계정과 관련 데이터(모먼·사진·위치·좋아요·프로필)가 즉시 영구 삭제됩니다.<br/>· 그룹 탈퇴/삭제 시 관련 데이터도 함께 삭제됩니다.
        </Sec>
        ...
        <Sec n="9" t="만 14세 미만 아동">
          만 14세 미만 아동의 가입 시 법정대리인 동의가 필요할 수 있으며, 관련 법령을 준수합니다.
        </Sec>
