    ...
    <div style={S.app}>
      ...
      <div style={S.body}>
        ...
        <Sec n="제2조" t="용어의 정의">
          ...
          · <b>그룹</b>: 안부를 함께 나누기 위해 구성한 모임<br/>
          · <b>안부</b>: 정해진/임의 시각에 함께 남기는 사진과 위치<br/>
        ...
        <Sec n="제5조" t="서비스의 제공 및 변경">
          · 그룹 내 안부 공유, 위치 확인, 알림 등을 제공합니다.<br/>· 운영·기술상 필요에 따라 기능이 변경될 수 있습니다.<br/>· 무료로 제공되며, 일부 기능 유료 전환 시 사전 공지합니다.
        </Sec>
        ...
        <Sec n="제8조" t="그룹 운영">
          · 그룹장은 그룹 이름, 안부 시간 등을 설정할 수 있습니다.<br/>· 구성원은 언제든 그룹에서 나갈 수 있습니다.<br/>· 그룹장이 그룹을 삭제하면 모든 데이터가 파기됩니다.
        </Sec>
